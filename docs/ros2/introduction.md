...
這個命名基本上每次都會在 ROS Discourse 上公開徵選，像是 [ROS 2 F Name Brainstorming](https://discourse.openrobotics.org/t/ros-2-f-name-brainstorming/11081)

到目前為止的 ROS 2 的 release 版本可以參考[官方網站](https://index.ros.org/)。
...
* [ROS 2 Rolling distribution plans](https://discourse.openrobotics.org/t/ros-2-rolling-distribution-plans/13227)
* [REP 2002](https://www.ros.org/reps/rep-2002.html)

## 好用的 ROS 資源

* [ROS Discourse](https://discourse.openrobotics.org/)：ROS 的官方討論區，全世界的 ROS 使用者會在這邊討論 ROS 相關的訊息，或是展現自己的成果
...
* [REPs](https://www.ros.org/reps/rep-0000.html)：Index of ROS Enhancement Proposals，ROS 相關的提案
