...
可以在 AGL 官網查詢過去的 [UCB 版本發布資訊](https://www.automotivelinux.org/tag/ucb/)。

## 常用連結

* [AGL 官網](https://www.automotivelinux.org/)：官方網站
* [AGL 官方文件](https://docs.automotivelinux.org/en/trout/)：AGL 的基礎教學
* [AGL Unified Code Base](https://www.automotivelinux.org/software/unified-code-base/)：UCB 的介紹、主要功能與支援的硬體
...
* [Discord](https://discord.com/invite/c3tngsS3)：AGL 社群交流的地方
